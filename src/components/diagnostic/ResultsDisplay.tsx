    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        <div className="w-20 h-20 bg-yellow-100 dark:bg-yellow-900 rounded-full flex items-center justify-center mx-auto mb-4">
          <div className="w-10 h-10 text-yellow-600 dark:text-yellow-400">
            <TrophyIcon />
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
        <div className="text-center mb-6">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Recommended Grade Level</p>
      ...
      <div className="flex gap-4">
        <button
          onClick={onRetake}
          className="flex-1 py-3 px-4 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200
                   dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-xl
        ...
        <button
          ...
          className="flex-1 py-3 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded-xl
