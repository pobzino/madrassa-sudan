...
export default function ExplorationOverlay({
  ...
  return (
    <div className="absolute inset-0 z-20 flex flex-col bg-gradient-to-b from-emerald-50 to-white">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-2.5 bg-gradient-to-r from-[#007229] to-[#00a63e] shrink-0">
