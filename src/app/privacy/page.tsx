...
export const metadata = {
  title: "Privacy Policy | Amal School",
  description: "Privacy policy for Amal School — how we collect, use, and protect your data.",
};

function MarkdownContent({ content }: { content: string }) {
  // Simple markdown-to-HTML: headings, bold, links, tables, lists, paragraphs
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // The page renders its own title and update date.
    ...
    if (listMatch) {
      ...
      if (!inList) {
        inList = true;
        listType = newType;
        html.push(`<${listType} class="list-${listType === "ul" ? "disc" : "decimal"} ${listType === "ul" ? "ps-5" : "ps-5"} my-2 space-y-1 text-gray-600">`);
      }
