...
const translations = {
  ...
  en: {
    ...
    homeworkCompleted: "Practice Done",
...
const achievements = [
  ...
  { id: "first_homework", Icon: PenLine, titleAr: "أول تدريب", titleEn: "First Practice", descAr: "أكمل تدريبك الأول", descEn: "Complete your first Practice", requirement: (stats: Stats) => stats.homework >= 1 },
  { id: "five_homework", Icon: ClipboardCheck, titleAr: "منجز التدريبات", titleEn: "Practice Star", descAr: "أكمل 5 تدريبات", descEn: "Complete 5 Practice activities", requirement: (stats: Stats) => stats.homework >= 5 },
