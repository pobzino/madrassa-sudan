...
const copy = {
  en: {
    ...
    hero: {
      ...
      primary: "Enrol your child",
      secondary: "Try a sample lesson",
      note: "Registration is free. Create a parent account, join the WhatsApp group, and start learning.",
    ...
    enrolment: {
      ...
      title: "Enrol in a few clear steps",
      body: "The parent or caregiver creates an account. You can use your WhatsApp number if you do not have an email address.",
      steps: [
        {
        ...
        {
          title: "Join the parent WhatsApp group",
          body: "After you create your account, you will receive a link to join the group for updates and support.",
        },
        {
          title: "Start learning",
          body: "Sign in with WhatsApp and your password, then open your child’s learning path.",
        },
      ],
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Your parent account is ready after registration. Join the parent WhatsApp group for updates and support, then sign in and begin your child’s learning path.",
        },
      ],
    },
    final: {
      title: "Ready to help your child keep learning?",
      body: "Create a parent account, join the WhatsApp group, and help your child begin learning.",
      cta: "Create a parent account",
  ...
  ar: {
    ...
    hero: {
      ...
      note: "التسجيل مجاني. أنشئ حساب ولي الأمر وانضم إلى مجموعة واتساب ثم ابدأ التعلّم.",
    ...
    enrolment: {
      ...
      title: "سجّل في خطوات واضحة",
      body: "ينشئ ولي الأمر أو مقدم الرعاية حساباً. ويمكنك استخدام رقم واتساب إذا لم يكن لديك بريد إلكتروني.",
      steps: [
        {
        ...
        {
          title: "انضم إلى مجموعة أولياء الأمور على واتساب",
          body: "بعد إنشاء الحساب، ستصلك وصلة للانضمام إلى المجموعة للحصول على التحديثات والدعم.",
        },
        {
          title: "ابدأوا التعلّم",
          body: "سجّل الدخول برقم واتساب وكلمة المرور وافتح مسار تعلّم طفلك.",
        },
      ],
      needTitle: "ما تحتاجه للتقديم",
      needs: ["رقم واتساب", "عمر طفلك", "الدولة والمدينة الحالية", "معلومات بسيطة عن الجهاز والاتصال بالإنترنت"],
      cta: "أنشئ حساب ولي الأمر",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "يصبح حساب ولي الأمر جاهزاً بعد التسجيل. انضم إلى مجموعة أولياء الأمور على واتساب للحصول على التحديثات والدعم، ثم سجّل الدخول وابدأ مسار تعلّم طفلك.",
        },
      ],
    },
    final: {
      title: "هل أنت مستعد لمساعدة طفلك على مواصلة التعلّم؟",
      body: "أنشئ حساب ولي الأمر وانضم إلى مجموعة واتساب وساعد طفلك على بدء التعلّم.",
      cta: "أنشئ حساب ولي الأمر",
